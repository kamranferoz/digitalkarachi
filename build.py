...
def featured_image_url(slug: str, title: str = "",
    ...
    Prefers a pre-generated AI image at site/wp-content/uploads/ai/posts/<slug>.jpg
    (generated by scripts/generate_ai_images.py). Falls back to loremflickr if
    the local file is missing.
    """
    ai_rel = f"wp-content/uploads/ai/posts/{slug}.jpg"
    if (SITE / ai_rel).exists():
        return ai_rel
    kws: list[str] = []
...
def news_image_url(slug: str, title: str = "") -> str:
    ...
    Prefers a pre-generated AI image at site/wp-content/uploads/ai/news/<slug>.jpg
    (generated by scripts/generate_ai_images.py). Falls back to loremflickr.
    """
    ai_rel = f"wp-content/uploads/ai/news/{slug}.jpg"
    if (SITE / ai_rel).exists():
        return ai_rel
